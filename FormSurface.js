...
define(function(require, exports, module) {
    ...
    function FormSurface(options) {
        ...
        this._container.action = this._action
        this._container.method = this._method
    ...
    FormSurface.prototype = Object.create(Surface.prototype);
    FormSurface.prototype.constructor = FormSurface;
    FormSurface.prototype.elementType = 'div';
    FormSurface.prototype.elementClass = 'famous-surface';
     ...
     */
    FormSurface.prototype.add = function add() {
     ...
     */
    FormSurface.prototype.render = function render() {
     ...
     */
    FormSurface.prototype.deploy = function deploy() {
     ...
     */
    FormSurface.prototype.commit = function commit(context, transform, opacity, origin, size) {
